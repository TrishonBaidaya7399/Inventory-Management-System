  ...
  return (
    <div className="add_new_form_container">
      <div className="globalTabs border-b border-gray-200 dark:border-gray-700 max-w-3xl mx-auto mt-6 rounded-md">
        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400 p-1">
          {tabsData.map((tab) => (
            <li key={tab.key} className="">
              <div
                onClick={() => handleTabChange(tab.key)}
                className={`inline-flex items-center justify-center p-4 h-full text-xl ${
                  activeTab === tab.key
